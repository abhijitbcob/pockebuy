...
<header class="relative child bg-black">
    <div class="container">
        <nav class="flex justify-between items-center py-8 border-b border-white border-opacity-20 relative">
            ...
            <a class="text-[26px] font-bold text-white leading-[1] focus-visible:outline-dotted outline-2 outline-brand outline-offset-4"
                href="/pockebuy">pockeBuy</a>
            <ul class="hidden items-center gap-8.5 lg:flex absolute left-1/2 transform -translate-x-1/2">
                <li><a class="header-nav-link focus-visible:outline-dotted outline-2 outline-brand outline-offset-4"
                        href="/pockebuy">home</a> </li>
                <li><a class="header-nav-link focus-visible:outline-dotted outline-2 outline-brand outline-offset-4"
                        href="headphones.php">headphones</a></li>
                <li><a class="header-nav-link focus-visible:outline-dotted outline-2 outline-brand outline-offset-4"
                        href="speakers.php">speakers</a></li>
                <li><a class="header-nav-link focus-visible:outline-dotted outline-2 outline-brand outline-offset-4"
                        href="earphones.php">earphones</a></li>
            </ul>

            <div class="flex items-center gap-3.5 md:gap-5">
                <button data-show-target="#search-modal"
                    class="text-white focus-visible:outline-dotted outline-2 outline-brand outline-offset-4" href="#"
                    aria-label="Search">
                ...
                <button data-show-target="#login-logout-modal"
                    class="text-white focus-visible:outline-dotted outline-2 outline-brand outline-offset-4" href="#"
                ...
                <button data-show-target="#cart-modal"
                    class="relative focus-visible:outline-dotted outline-2 outline-brand outline-offset-4">
