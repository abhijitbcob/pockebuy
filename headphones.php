...
$cursor = $collection->find(['category' => "headphones"]);
...
<body>
    ...
    <main class="pb-[120px] lg:pb-40 relative">
      ...
      ?>
            <div class="flex flex-col lg:flex-row justify-between items-center gap-y-8
                md:gap-y-[52px] lg:gap-x-20 mt-16 md:mt-[120px] lg:mt-40">
                <picture class="<?php
                          if ($isEven === true) {
                            echo "lg:order-2";
                          }
