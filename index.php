...
<body class="relative">
    <div
        class="hero-header-wrapper bg-mobile-hero md:bg-tablet-hero lg:bg-desktop-hero bg-100% parent child-bg-transparent">
            ...
            <div class="container">
                <div
                    ...
                    <a href="./single-product.php?id=4"
                        class="btn-type-1 btn-type-1--brand mt-10 focus-visible:outline-dotted outline-2 outline-brand outline-offset-4">see
                        product</a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div
                ...
                <div
                    ...
                    <p class="mt-6 text-base font-medium leading-25 text-white text-opacity-75">Upgrade to premium
                        speakers
                        that
                        are phenomenally
                        built to deliver truly remarkable sound.</p>
                    <a class="mt-6 md:mt-10 btn-type-1 btn-type-1--black focus-visible:outline-dotted outline-2 outline-current outline-offset-4"
                        href="./single-product.php?id=6">see
                        product</a>
                </div>
            </div>
            ...
            <div
                ...
                <a class="btn-type-1 btn-type-1--transparent mt-8 focus-visible:outline-dotted outline-2 outline-current outline-offset-4"
                    href="./single-product.php?id=5"> see product</a>
            </div>
            ...
            <div class="grid md:grid-cols-2 mt-6 md:mt-8 lg:mt-12 gap-y-6 md:gap-x-2.5 lg:gap-[1.875rem]">
                ...
                <div class="bg-light-grey py-[6.25rem] pl-6 md:pl-[3.875rem] lg:pl-24 rounded items-stretch">
                    ...
                    <a class="btn-type-1 btn-type-1--transparent mt-8 focus-visible:outline-dotted outline-2 outline-current outline-offset-4"
                        href="./single-product.php?id=1"> see product</a>
                </div>
            </div>
            ...
            <div
                ...
                <picture class="lg:order-2">
                    ...
                    <img width="540px" height="588px" class="rounded w-full"
                        src="./assets/shared/mobile/image-best-gear.jpg" alt="man weared headphone">
                </picture>
                <article class="md:max-w-573 lg:max-w-445 lg:order-1 text-center lg:text-left">
                    <h2 class="uppercase text-2xl md:text-4xl tracking-1 md:tracking-1.5 font-bold md:leading-44">
                        Bringing you the
                        <span class="text-brand">best</span>
                        audio
                        gear
                    </h2>
                    <p class="text-base font-medium leading-25 text-black text-opacity-50 mt-8"> Located at the heart of
                        New
                        York
